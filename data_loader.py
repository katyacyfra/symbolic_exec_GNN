...
def get_data():
    dl = DataLoader("/home/crypto/GNN_V#/Samples_2_with_reward_and_different_strategies")
    #DataLoader("/home/crypto/GNN_V#/Samples_2_with_reward_and_different_strategies")
    return dl.dataset
